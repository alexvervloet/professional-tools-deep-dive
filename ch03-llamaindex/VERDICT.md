...
All three pipelines — hand-rolled (12 word-window chunks), LlamaIndex as it
ships (4 whole-doc chunks), LlamaIndex matched to the baseline (17
sentence-aware chunks) — scored **100% hit rate and ~1.0 MRR and 100%
answer-fact** on the same 12 questions. On a small corpus of well-separated
...
— older on both model axes and more expensive on both. The dive's version of
